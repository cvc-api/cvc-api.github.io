...
export default function GetCourseIDsBySearch(){
    return (
        <>
    <div className="items-center justify-items-center min-h-screen font-[family-name:var(--font-geist-sans)]">
      <main className="w-full flex flex-col  row-start-2 items-center sm:items-start">
        ...
        Using the provided college name, searches for all the CVC IDs of the classes in the college which would be returned in a query with the above parameters. Returns a list of the found IDs.        </span>
